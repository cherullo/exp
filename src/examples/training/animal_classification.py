...
exp.add_validation_set([FilterColumn(columns.LABEL, [labels.COW]), LastPercent(0.2)], RotationLoader(resize=dimension,spread=10.0))
exp.add_validation_set([FilterColumn(columns.LABEL, [labels.SHEEP]), LastPercent(0.2)], RotationLoader(resize=dimension,spread=10.0))
